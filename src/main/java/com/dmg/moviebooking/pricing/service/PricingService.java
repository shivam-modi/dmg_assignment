...
/**
 * Price resolution only — separated from admin CRUD (see {@link PricingRuleAdminService}) since
 * they change for different reasons: this class changes when pricing rules change, the admin
 * service when the management API shape changes.
 */
@Service
